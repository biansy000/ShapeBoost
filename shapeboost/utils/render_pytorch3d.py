...
def render_mesh(vertices, faces, translation, focal_length, height, width, verts_rgb=None, device=None, center=None):
    ...
    rot = Rotation.from_euler(
        'z', 180, degrees=True).as_matrix().astype(np.float32)
