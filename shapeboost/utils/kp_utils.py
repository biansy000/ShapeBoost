...
def get_mpii3d_test_new_joint_names():
    return [
        "rankle",    # 0  "lankle",    # 0
        "rknee",     # 1  "lknee",     # 1
        "rhip",      # 2  "lhip",      # 2
...
# def get_smpl29_joint_names():
#     return [
#         'pelvis', "lhip", "rhip",      # 2
#         'spine1', "lknee", "rknee",    # 5
#         'spine2', "lankle", "rankle",  # 8
#         'spine3', 'left_foot', 'right_foot',    # 11
#         "neck", 'left_collar', 'right_collar',  # 14
#         'jaw',                                  # 15
#         "lshoulder", "rshoulder",      # 17
#         "lelbow", "relbow",            # 19
#         "lwrist", "rwrist",            # 21
#         'left_thumb', 'right_thumb',            # 23
#         "headtop", 'left_middle', 'right_middle',  # 26
...
def translate_mpii3d_imgname(raw_names):
    ...
    for item in raw_names:
        ...
        new_path = os.path.join('data/3dhp/mpi_inf_3dhp_train_set', parent_paths[2], parent_paths[3], 
                            'images', new_name)
