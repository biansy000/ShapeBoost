...
from shapeboost.utils.presets.simple_transform_3d_cam_eft import SimpleTransform3DCamEFT
...
class COCO_EFT_3D(data.Dataset):
    ...
    def load_pt(self):
        db = joblib.load(self._ann_file + '_smpl_annot_niki_uv.pt')
        return db
